<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SecureCloudStorage.Login" %>
        ...
        <table align="center" width="30%">
            <tr>
                <td align="center">
                    <br />
                    <br />
                    <asp:Label ID="Label1" runat="server" Text="USER LOGIN" Font-Bold="True" Font-Size="16pt" ForeColor="#FCCE54"></asp:Label>
                    <hr />
                    <br />
                </td>
            </tr>
